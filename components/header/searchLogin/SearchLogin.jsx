...
const SearchLogin = () => {
  return (
    <div className=" flex items-center gap-7 max-md:hidden">
      ...
      <div className="p-2 rounded-full max-lg:hidden  bg-indigo-200 hover:bg-indigo-300 ">
        <Image
      ...
      <div className="sign-in text-[#101214] text-lg py-1 px-4 max-lg:hidden hover:text-[#0065FF] transition-all duration-200 ease-in-out ">
        Sign in
      </div>
    </div>
  );
